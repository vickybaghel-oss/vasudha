...
export default function PrivacyPage() {
  return (
    <main className="page-gutter min-h-screen bg-background py-32 md:py-40">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-stone mt-10 max-w-none text-sm leading-7 text-foreground/80 space-y-6">
          <p>
            This privacy policy describes how {site.name} (&quot;we&quot;, &quot;us&quot;) handles information
            collected through {site.domain} (the &quot;Site&quot;).
          </p>

          <h2 className="font-display text-2xl text-heading pt-4">Information we collect</h2>
          <p>
          ...
          <h2 className="font-display text-2xl text-heading pt-4">How we use information</h2>
          <p>
          ...
          <h2 className="font-display text-2xl text-heading pt-4">Sharing</h2>
          <p>
          ...
          <h2 className="font-display text-2xl text-heading pt-4">Contact us</h2>
          <p>
